        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Capacity = table.Column<int>(type: "int", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SuggestedCategories = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    State = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VenueRequests_Users_OrganizerId",
                        column: x => x.OrganizerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventVectors", x => x.EventId);
                    table.ForeignKey(
                        name: "FK_EventVectors_Events_EventId",
                        column: x => x.EventId,
            ...
            migrationBuilder.CreateTable(
                name: "VenueRequestCategories",
                columns: table => new
                {
                    VenueRequestId = table.Column<int>(type: "int", nullable: false),
                    CategoryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VenueRequestCategories", x => new { x.VenueRequestId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_VenueRequestCategories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VenueRequestCategories_VenueRequests_VenueRequestId",
                        column: x => x.VenueRequestId,
                        principalTable: "VenueRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VenueRequestCategories_CategoryId",
                table: "VenueRequestCategories",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_VenueRequests_OrganizerId",
                table: "VenueRequests",
                column: "OrganizerId");
